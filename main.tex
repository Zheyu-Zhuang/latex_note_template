...
\input{util/preamble} % All the packages and some of the general newcommands
...
\begin{table*}
    ...
    \begin{tabular}{c c c c c c c}
        \toprule
                       & \makecell{PVNet$^*$ \\ABC} & \makecell{PoseCNN +\\ICP~} & \makecell{DOPD\\ ABC} & \makecell{DenseFusion\\} & \makecell{SSD6D+\\ICP~} & \makecell{DOPE} \\
        \midrule
